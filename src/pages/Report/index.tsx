    ...
    <section className="section max-w-6xl mx-auto px-2">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2 flex items-center">
          <SiteHeader
            title="Relatório de Marketing Digital"
            icon={<FaChartLine className="fab fa-facebook text-blue-600 mr-3" />}
          />
        </h2>
      </div>
      ...
      <div className="p-4">
        ...
        <section className="mb-10">
          <h3 className="text-xl font-bold mb-4 text-white">Crescimento das Plataformas</h3>
