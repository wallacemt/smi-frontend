...
const YouTubeAnalytics = () => {
  return (
    <section className="section max-w-6xl px-2 mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2 flex items-center">
          <SiteHeader title="Análise do YouTube" icon={<FaYoutube className="text-red-500 mr-3 text-2xl" />} />
        </h2>
        <p className="text-gray-400 ml-12">Canal BaixioTurismo - Métricas detalhadas</p>
      </div>
